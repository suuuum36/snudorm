...
urlpatterns = [
    ...
    path('<str:board>/<str:category>/<int:fid>/', views.showFeed, name='showfeed'),
    path('<str:board>/<str:category>/<int:fid>/edit/', views.editFeed, name='editfeed'),
    path('<str:board>/<str:category>/<int:fid>/delete/', views.deleteFeed, name='deletefeed'),
