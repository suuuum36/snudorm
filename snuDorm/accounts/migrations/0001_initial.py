    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building_category', models.CharField(choices=[('master', '대학원생활관'), ('BK', 'BK생활관'), ('bachelor', '학부생활관'), ('family', '가족생활관')], max_length=20, verbose_name='생활관')),
                ('building_dong', models.CharField(choices=[('906', '906동'), ('904', '904동'), ('903', '903동'), ('901', '901동'), ('900', '900동'), ('902', '902동'), ('905', '905동')], max_length=20, verbose_name='동')),
